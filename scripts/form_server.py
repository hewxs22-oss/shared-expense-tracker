...
FORM_DATA_PATH = os.path.join(BASE_DIR, "form_data.json")
...
ECR_QUESTIONS_ZH = [
    ...
    "我觉得和伴侣亲近相对容易。",  # 反向题
    "和伴侣亲近对我来说并不难。",  # 反向题
    "我通常会和伴侣讨论我的烦恼和顾虑。",  # 反向题
    "在需要的时候，向伴侣寻求支持对我很有帮助。",  # 反向题
    "我几乎什么都会告诉伴侣。",  # 反向题
    "我会和伴侣一起商量事情。",  # 反向题
    "当伴侣靠得太近时，我会感到紧张。",
    "我很自在地依赖伴侣。",  # 反向题
...
def submit():
    ...
    if all_users == submitted_users:
        ...
        # 写入 pending 状态，等待用户在飞书群选择模式
        with open(MODE_PATH, "w") as f:
            json.dump({"mode": "pending"}, f)
        save_form_data({})  # 清空
